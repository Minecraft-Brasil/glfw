...
GLFWbool _glfwInitEGL(void)
{
    ...
    if(!_glfw.egl.GetProcAddress) {
        _glfwInputError(GLFW_PLATFORM_ERROR,
                        "EGL: Failed to load required entry point \"eglGetProcAddress\"");

        _glfwTerminateEGL();
        return GLFW_FALSE;
    }

    _glfw.egl.GetConfigAttrib = (PFN_eglGetConfigAttrib) _glfw.egl.GetProcAddress("eglGetConfigAttrib");
    _glfw.egl.GetConfigs = (PFN_eglGetConfigs) _glfw.egl.GetProcAddress("eglGetConfigs");
    _glfw.egl.GetDisplay = (PFN_eglGetDisplay) _glfw.egl.GetProcAddress("eglGetDisplay");
    _glfw.egl.GetError = (PFN_eglGetError) _glfw.egl.GetProcAddress("eglGetError");
    _glfw.egl.Initialize = (PFN_eglInitialize) _glfw.egl.GetProcAddress("eglInitialize");
    _glfw.egl.Terminate = (PFN_eglTerminate) _glfw.egl.GetProcAddress("eglTerminate");
    _glfw.egl.BindAPI = (PFN_eglBindAPI) _glfw.egl.GetProcAddress("eglBindAPI");
    _glfw.egl.CreateContext = (PFN_eglCreateContext) _glfw.egl.GetProcAddress("eglCreateContext");
    _glfw.egl.DestroySurface = (PFN_eglDestroySurface) _glfw.egl.GetProcAddress("eglDestroySurface");
    _glfw.egl.DestroyContext = (PFN_eglDestroyContext) _glfw.egl.GetProcAddress("eglDestroyContext");
    _glfw.egl.CreateWindowSurface = (PFN_eglCreateWindowSurface) _glfw.egl.GetProcAddress("eglCreateWindowSurface");
    _glfw.egl.CreatePbufferSurface = (PFN_eglCreatePbufferSurface) _glfw.egl.GetProcAddress("eglCreatePbufferSurface");
    _glfw.egl.MakeCurrent = (PFN_eglMakeCurrent) _glfw.egl.GetProcAddress("eglMakeCurrent");
    _glfw.egl.SwapBuffers = (PFN_eglSwapBuffers) _glfw.egl.GetProcAddress("eglSwapBuffers");
    _glfw.egl.SwapInterval = (PFN_eglSwapInterval) _glfw.egl.GetProcAddress("eglSwapInterval");
    _glfw.egl.QueryString = (PFN_eglQueryString) _glfw.egl.GetProcAddress("eglQueryString");
